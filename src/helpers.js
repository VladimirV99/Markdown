export const asteriskDashTildeAndColon = /([*_:~])/g;
export const asteriskDashAndTilde = /([*_~])/g;
...
export function rgxFindMatchPos(str, left, right, flags) {
  let f = flags || '',
      g = f.indexOf('g') > -1,
...
export function escapeCharacters (text, charsToEscape, afterBackslash) {
...
export function escapeCharactersCallback (wholeMatch, m1) {
...
export function _hashHTMLSpan (html, globals) {
